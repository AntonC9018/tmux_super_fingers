...
FINGERS_FLAGS=$(tmux show-option -gqv @super-fingers-flags)
FINGERS_KEY=${FINGERS_KEY:-$DEFAULT_FINGERS_KEY}
FINGERS_EXTEND=$(tmux show-option -gqv @super-fingers-extend)

tmux bind $FINGERS_FLAGS "$FINGERS_KEY" new-window -e "FINGERS_EXTEND=$FINGERS_EXTEND" -d -n super-fingers "$CURRENT_DIR/run.sh"
